...
export const personaData = {
    ...
    'raps-status': {
        ...
        phase: 'utility',
        description: 'Unified dashboard for project status and health validation. Get an instant snapshot of the project state without modifying anything.',
        responsibilities: [
