...
### `CODE_INDEX.md`
*   **Responsible:** **System** (Auto-generated by `generate_code_index.ps1`)
*   **Type:** **Living**
*   **Purpose:** Auto-generated index of project code files (components, routes, migrations). Supplements `PLAN.md` Section 5 which tracks template artifacts.
*   **Audience:** Build, Design, Test Agents
*   **Lifecycle:**
