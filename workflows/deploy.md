...
- **Lane:** Owner of `/infrastructure`, `/docker`, `.github/workflows`. Read access to all code.
...
4. [ ] *(Recommended)* Run `/health` before next sprint for clean slate
...
4. [ ] *(Required)* Run `/health` to diagnose issues
